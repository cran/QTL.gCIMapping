...
WenF<-function(pheRaw=NULL,genRaw=NULL,mapRaw1=NULL,yygg1=NULL,cov_en=NULL,WalkSpeed=NULL,CriLOD=NULL,dir=NULL){
...
#'
#' @param flag random or fix model.
#' @param CriLOD LOD score.
#' @param NUM the number of trait.
#' @param pheRaw raw phenotype matrix.
#' @param Likelihood likelihood function.
#' @param SetSeed random seed set in which,the cross validation is needed.
#' @param flagrqtl do CIM or not.
#' @param yygg covariate matrix.
#' @param mx raw genotype matrix.
#' @param phe phenotype matrix.
#' @param chr_name chromosome name.
#' @param v.map linkage map matrix.
#' @param gen.raw raw genotype matrix.
#' @param a.gen.orig additive genotype matrix.
#' @param d.gen.orig dominant genotype matrix.
#' @param n number of individual.
#' @param names.insert2 linkage map after insert.
#' @param X.ad.tran.data genotype matrix after insert.
#' @param X.ad.t4 genotype matrix.
